...
CREATE TABLE status_jugada (
       id_status_jugada INT NOT NULL AUTO_INCREMENT
     , desc_jugada VARCHAR(30) NOT NULL
     , UNIQUE UQ_status_jugada_1 (desc_jugada)
...
CREATE TABLE jugada_juego_equipo (
       id_jugada_juego_equipo INT NOT NULL AUTO_INCREMENT
...
ALTER TABLE jugada
  ADD CONSTRAINT FK_jugada_3
      FOREIGN KEY (id_usuario)
      REFERENCES usuario (id_usuario);

ALTER TABLE jugada
  ADD CONSTRAINT FK_jugada_4
      FOREIGN KEY (id_usuario)
      REFERENCES usuario (id_usuario);

ALTER TABLE jugada
  ADD CONSTRAINT FK_jugada_5
      FOREIGN KEY (id_status_jugada)
      REFERENCES status_jugada (id_status_jugada);
...
ALTER TABLE jugada_juego_equipo
  ADD CONSTRAINT FK_jugada_juego_equipo_3
      FOREIGN KEY (id_jugada)
      REFERENCES jugada (id_jugada);

ALTER TABLE jugada_juego_equipo
  ADD CONSTRAINT FK_jugada_juego_equipo_2
      FOREIGN KEY (id_usuario_juego_equipo)
      REFERENCES usuario_juego_equipo (id_usuario_juego_equipo);

ALTER TABLE jugada_juego_equipo
  ADD CONSTRAINT FK_jugada_juego_equipo_4
      FOREIGN KEY (id_status_jugada)
      REFERENCES status_jugada (id_status_jugada);
