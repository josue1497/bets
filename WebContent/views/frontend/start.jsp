...
if(listaVista==null || listaVista.size()==0) {
	...
	vistaTO.setTitle(Constants.getDominio(request).getNombre());
	vistaTO.setContent("El mejor sistema online de parley");
	vistaTO.setImage("home.jpg");
	vistaTO.setStatus("1");
...
%>
	...
	<!--<div class="caption" style='position:absolute;left:0;'><div class="content"><h3>BETCESC</h3>Mensaje de inicio</div></div>-->
