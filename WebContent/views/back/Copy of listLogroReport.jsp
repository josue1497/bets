...
<table align="center" width="98%" cellspacing="0" cellpadding="0" border="0" >
	<tr>
		...
		<td rowspan="2" align="center">
			<img src="<%=basePath%>images/<%=request.getAttribute("titulo").toString().toLowerCase().replaceAll(" ","_")%>.gif">
		</td>
		<%}%>
...
<table align="center" width="98%" cellspacing="0" cellpadding="0" border="1" BORDERCOLOR="#Bf8f0f" >
