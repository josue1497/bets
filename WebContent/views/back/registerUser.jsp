		...
		<table width="100%" height="100%" border="0" cellpadding="5" cellspacing="5" class="tablaCaption">
			...
			<tr>
		  	...
		  	<tr>
		  		...
		  		<tr>
			  	<td class="etiqueta"><bean:message key="usuario.jugadaMinima" /></td>
			  	<td class="etiqueta">&nbsp;:&nbsp;</td>
			  	<td class="etiquetaLeft"><html:text name="user" property="jugadaMinima" size="10" maxlength="9" /></td>
		  	</tr>
		  	<tr>
		  	...
		  	<tr style="display:<%=isAdminGeneral?"":"none"%>" >
			  	...
			  	<td class="etiquetaLeft" >
 			  		...
 			  		<html:select name="user" property="dominio" > 
                        ...
                        <html:option value="000">betcesc.com</html:option>
			  			<html:option value="001">apuestas222.com</html:option>
			  			<html:option value="002">apuestacaliente.com</html:option>
			  			<html:option value="003">betsports04.com</html:option>
                        <html:option value="004">parleynikols.com</html:option>
                        <html:option value="005">motilonsports.com</html:option>
                        <html:option value="006">lagranapuesta.com</html:option>
                        <html:option value="007">tumundoparley.com</html:option>
                        <html:option value="008">apuestabogota.com</html:option>
                        <html:option value="009">apuestagold.com</html:option>
                        <html:option value="010">ganarsport.com</html:option>
                         <html:option value="011">parleycolombia.com</html:option>
                          <html:option value="012">bcashonline.com</html:option>
                           <html:option value="013">apuestafinal.com</html:option>
                           <html:option value="014">parleydetodos.com</html:option>
                           <html:option value="015">goldparley.com</html:option>
                           <html:option value="016">tugranjugada.com</html:option>
                           <html:option value="017">ZonaParley.com</html:option>
                           <html:option value="018">reyapuesta.net</html:option>
