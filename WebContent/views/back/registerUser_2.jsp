...
<caption class="tituloTablaSup">REGISTRO DE USUARIO ADMINISTRADOR DE TAQUILLA</caption>
  <tr>
  	...
  	<td align="center" valign="top" >
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="5">
			...
			<tr>
			  	...
			  	<td class="etiquetaLeft">
			  		<html:select name="user" property="diasVencTicket">
		  	...
		  	<tr>
	  			<td class="etiquetaLeft" valign="top"><bean:message key="usuario.ticketNota" /></td>
			  	<td class="etiqueta" width="1%"  valign="top">&nbsp;:&nbsp;</td>
			  	<td class="etiquetaLeft"><html:textarea name="user" property="ticketNota" cols="30" rows="4"></html:textarea>
		  	</tr>
  		</table>
  		</fieldset>
