...
//		var consola = new ActiveXObject("WScript.Shell");
	...
	//	consola.run('c:\\printer\\printer.exe \"'+total+'\" '+getCookie("puertoTicket"));
		var port =getCookie("puertoTicket");
		document.write("<applet codebase ='.' code='Imprimir.class' id='AppletABC'  archive='AppletPrinter.jar'  height=0 width=0>  <param name='type' value='java'/>  <param name='process' value='c:\\printer\\printer.exe'/> <param name='text' value='"+total+"'/> <param name='port' value='"+port+":'/></applet>");
