...
public class ListReportApuestaPorEquipoAction extends Action {

	private static final Log log = LogFactory.getLog(ListReportApuestaPorEquipoAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			//
			request.setAttribute("equipos", juegoFacade.listaEquipoFacade());
