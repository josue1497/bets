...
public class ListApuestaPorEquipoAction extends Action {

	private static final Log log = LogFactory.getLog(ListApuestaPorEquipoAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			lista = juegoFacade.listaApuestaPorEquipoFacade(usuario,oJugadaTO,oJugada2TO,orden,taquilla, idEquipo);
			
			if(idEquipo!=null && idEquipo.equals(Constants.ID_EQUIPO_EMPATE)) {
				TreeMap juegos = juegoFacade.listaApuestaPorEquipoEmpateFacade(lista);
				request.setAttribute("juegosEquipos", juegos);
			}
