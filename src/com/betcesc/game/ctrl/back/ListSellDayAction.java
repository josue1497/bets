...
public class ListSellDayAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			lista = juegoFacade.listaJugadaFacade(usuario,oJugadaTO,oJugada2TO,orden,taquilla);
			
			listaVencida = juegoFacade.listaJugadaVencidaFacade(usuario,oJugadaTO,oJugada2TO,orden,taquilla);
			...
			request.setAttribute("listaVencida",listaVencida);
