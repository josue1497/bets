...
public class ListSellDayResumeAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			String[] usuarios = request.getParameterValues("jugador");
			...
			lista = juegoFacade.listaJugadaResumidaFacade(usuario,oJugadaTO,oJugada2TO,orden,taquilla, dominio);
			
			TreeMap vencido = juegoFacade.listaJugadaResumidaVencidaFacade(usuario,oJugadaTO,oJugada2TO,orden,taquilla, usuarios);
			...
			request.setAttribute("dominioList",dominio);
